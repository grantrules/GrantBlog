...
namespace GrantBlog.Controllers
{
    public class BlogPostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CreationDate,Intro,PublishDate,Text,Title")] BlogPost blogPost)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CreationDate,Intro,PublishDate,Text,Title")] BlogPost blogPost)
        {
            if (id != blogPost.Id)
            {
                return NotFound();
